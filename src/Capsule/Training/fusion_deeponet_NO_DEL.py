...
for epoch in range(num_epochs_adam):
    ...
    if epoch % 10 ==0:
        ...
        loss_test,l2_test,l2_diff_test= loss_for_test(params, [v_te, x_te],u_te,u_te_der,der_lim,nn_idx_batch_jax_te)
        losss,l2_train,l2_diff_train= loss_for_test(params, [v_tr, x_tr],u_tr,u_tr_der,der_lim,nn_idx_batch_jax)
        
        train_loss.append(losss)
        test_loss.append(loss_test)
        epo.append(epoch)
        print("Epoch {} | T: {:0.6f} | Train MSE: {:0.3e} | Test MSE: {:0.3e} | Train L2: {:0.5f} | Test L2: {:0.5f} | Diff_Train L2: {:0.5f} | Diff_Test L2: {:0.5f}".format(epoch, epoch_time,losss,loss_test,l2_train, l2_test,l2_diff_train,l2_diff_test))
